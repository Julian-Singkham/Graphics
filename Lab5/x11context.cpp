/**
  ...
  ***********************************************************************************
  * @attention
  * Provides a simple drawing context for X11/XWindows. You must have the X11 dev 
  * libraries installed.  If missing, 'sudo apt-get install libx11-dev' should help.
  ***********************************************************************************
**/
