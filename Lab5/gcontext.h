/**
  ***********************************************************************************
  * @file   : gcontext.h
  * @brief  : Outline for Graphics Context
  *         : Lab 5: Shapes Classes and Shapes Container
  *         : CS-3210/021 
  * @date   : APR 27 2021
  * @author : unknown (provided)
  ***********************************************************************************
  * This class is intended to be the abstract base class for a graphical context
  * for various platforms. Any concrete subclass will need to implement the pure 
  * virtual methods to support setting pixels, getting pixel color, setting the 
  * drawing mode, and running an event loop to capture mouse and keyboard events 
  * directed to the graphics context (or window).  Specific expectations for the 
  * various methods are documented below.
  *********************************************************************************** 
**/
#ifndef GCONTEXT_H
#define GCONTEXT_H
